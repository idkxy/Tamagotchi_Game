...
/**
 * This class contains all the details of the pet's competition with a method
 * that checks if the pet is eligible to enter the game
 *
...
public class Competition {
    ...
    /**
     * Ask if the user wants to enter the competition and print corresponding
     * information when y/n is pressed
     *
