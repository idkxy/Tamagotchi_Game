...
public class Data {
    ...
    public static void saveGame(ArrayList<Pet> petCollection) throws FileNotFoundException
    {
        ...
        pw.println("@PETS");
        petCollection.forEach((v) -> pw.println(v.getName() + "," + v.stats.getHunger() + "," + v.stats.getThirst() + "," + v.stats.getEnergy() + "," + v.stats.getHappiness() + "," + v.getGender() + "," + v.getMaturity() + "," + v.getSpecies()));
        pw.close();
    }
}
